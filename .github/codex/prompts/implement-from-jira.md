...
5.    Do not run API/supertest tests inside the Codex action sandbox.
6. If challenge-related code is modified, run or document the need for `npm run rsn`.
7. Write `docs/${ISSUE_KEY}/pr-summary.md` with:
   - Jira link/key
   - Summary
